...
export async function getDeadlineAlerts(): Promise<{ success: boolean; data: NotificationItem[] }> {
    try {
        ...
        // 1. Invoices (Receivable) - UNPAID & Due Date exists
        ...
        for (const inv of invoices) {
            ...
            const isDueSoon = !isOverdue && isBefore(inv.dueDate, nextWeek);
        ...
        // 2. Bills (Payable) - Not PAID & Due Date exists
        ...
        for (const bill of bills) {
            ...
            const isDueSoon = !isOverdue && isBefore(bill.dueDate, nextWeek);
        ...
        // 3. Sales Opportunities - OPEN & Deadline exists
        ...
        for (const opp of opportunities) {
            ...
            const isDueSoon = !isOverdue && isBefore(opp.deadline, nextWeek);
