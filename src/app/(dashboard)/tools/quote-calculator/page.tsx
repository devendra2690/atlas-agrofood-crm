...
export default function QuoteCalculatorPage() {
    ...
    return (
        <div className="space-y-6 max-w-5xl mx-auto">
            <div>
                <h2 className="text-3xl font-bold tracking-tight text-slate-800">Quote Engine</h2>
                <p className="text-muted-foreground text-sm mt-1">
                    Calculate Total Cost of Production (TCP) and tiered sales pricing using the Hierarchical Waterfall engine.
                </p>
            </div>
