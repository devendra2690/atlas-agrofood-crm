...
import { ArrowLeft, Building, Mail, Phone, Calendar, Briefcase, ShoppingCart, FileText } from "lucide-react";
                ...
                <div className="flex items-start justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight flex items-center gap-3">
                            ...
                            <TrustLevelSelector
                                vendorId={company.id}
                                // @ts-ignore - trustLevel may not be in type yet if not regenerated or generic issue, but safe at runtime
                ...
                <div className="md:col-span-2 space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Associated sourcing projects and samples.</CardDescription>
                        </CardHeader>
                        <CardContent>
