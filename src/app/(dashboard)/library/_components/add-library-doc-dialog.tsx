...
interface AddLibraryDocDialogProps {
    onSuccess: () => void;
}

export function AddLibraryDocDialog({ onSuccess }: AddLibraryDocDialogProps) {
            ...
            <DialogContent className="sm:max-w-lg">
                ...
                <div className="space-y-4 mt-2">
                    ...
                    <div className="grid gap-1.5">
                        ...
                        <div
                            className="flex items-center gap-3 border-2 border-dashed rounded-lg p-4 cursor-pointer hover:border-blue-400 transition-colors bg-slate-50"
                    ...
                    <div className="grid gap-1.5">
                        ...
                        <Textarea
                            placeholder="What is this document about? Who should use it?"
                            value={description}
